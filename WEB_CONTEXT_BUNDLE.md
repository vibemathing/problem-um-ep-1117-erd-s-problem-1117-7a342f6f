...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1117-erd-s-problem-1117-7a342f6f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1117"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1117-erd-s-problem-1117-7a342f6f-v1",
      "problem_contract_sha256": "54e83a71a49834b1985cf7a7bbf3b71e6aa50e49756dee6c0a402ac3eaea28b4",
      "problem_id": "problem:um-ep-1117-erd-s-problem-1117-7a342f6f",
      "route_id": "route:um-ep-1117-erd-s-problem-1117-7a342f6f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1117-erd-s-problem-1117-7a342f6f-source-fidelity-01",
      "graph_id": "graph:um-ep-1117-erd-s-problem-1117-7a342f6f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1117-erd-s-problem-1117-7a342f6f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1117-erd-s-problem-1117-7a342f6f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(z)$ be an entire function which is not a monomial. Let $ u(r)$ count the number of $z$ with $\\lvert z\\rvert=r$ such that $\\lvert f(z)\\rvert=\\max_{\\lvert z\\rvert=r}\\lvert f(z)\\rvert$. (This is a finite quantity if $f$ is not a monomial.) Is it possible for $ \\limsup u(r)=\\infty? $ Is it possible for $ \\liminf u(r)=\\infty? $"
          },
          "statement_sha256": "11b36b72de9d9cd40238c750c2265fde2869dd7997107444db087f93458c07ba"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1117-erd-s-problem-1117-7a342f6f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1117-erd-s-problem-1117-7a342f6f-root",
      "route_id": "route:um-ep-1117-erd-s-problem-1117-7a342f6f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1117-d4a8bfff3f09",
        "url": "https://www.unsolvedmath.com/problems/EP-1117"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
